      ...
      children: [
        ...
        AspectRatio(
          ...
          child: Center(
            child: Text(
              places[_current],
              style: TextStyle(letterSpacing:  8, fontFamily:  'Electolize',fontSize: screenSize.width / 25,color: Colors.white),
            ),
          ),
        ),
      screenSize.width < 800 ? Container():AspectRatio(aspectRatio: 17 / 8,
        child: Center(
          heightFactor: 1,
          child: Align(
